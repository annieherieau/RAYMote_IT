...
ActiveRecord::Schema[7.1].define(version: 2024_03_26_112838) do
  ...
  create_table "course_items", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["workshop_id"], name: "index_course_items_on_workshop_id"
  end
  ...
  add_foreign_key "course_items", "workshops"
